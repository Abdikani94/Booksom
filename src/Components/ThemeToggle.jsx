...
function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="text-gray-500 dark:text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 
    ...
    >
      {isDark ? (
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
          ...
          <path
            ...
            d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 
               4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 
               ...
               100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 
               11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 
        ...
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
          ...
          <path d="M16.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z" />
        </svg>
      )}
    </button>
  );
