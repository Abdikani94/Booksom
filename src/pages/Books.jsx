...
function Books({ auth }) {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 text-gray-800 dark:text-white">
      ...
      <main className="min-h-screen flex flex-col justify-between pt-24 pb-10">
        {/* Hero Section */}
        <div className="w-full relative p-16 md:p-28 mb-12 rounded-3xl overflow-hidden shadow-2xl max-w-7xl mx-auto">
          <div
        ...
        <div id="explore-books" className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-8">
            {currentBooks.length ? (
                  ...
                  <div className="bg-black/60 backdrop-blur-md border border-gray-700 rounded-2xl shadow-lg hover:scale-[1.02] transition-transform duration-300 overflow-hidden group flex flex-col">
                    ...
                    <div className="p-4 text-white space-y-2 flex flex-col flex-grow">
                      <div className="space-y-0.5">
                        <h2 className="text-lg font-semibold truncate">{book.name}</h2>
                      ...
                      <div className="mt-auto pt-3 flex justify-between items-center">
                        <button
                          ...
                          className="flex items-center gap-1 text-white hover:text-gray-200 text-sm transition"
                        >
              ...
              <p className="col-span-full text-center text-xl text-gray-400">🚫 No books found.</p>
            )}
          </div>
